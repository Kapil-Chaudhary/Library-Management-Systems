...
//		return(args) -> {
//			Book book1=new Book("Star","You Forever", true, "You know what i am thinking {Thriller} ");
...
//
//
//			Book book2=new Book("B","Positions", true, "We found each other. ");
...
//
//			Book book3=new Book("C","Atif",true, "Pehli Daffa. ");
